...
TARGETS = {
    ROOT / "skills/e2e-testing": frozenset({"e2e.web", "e2e.service", "e2e.mobile", "e2e.desktop"}),
    ROOT / "skills/e2e-web": frozenset({"e2e.web"}),
    ROOT / "skills/e2e-service": frozenset({"e2e.service"}),
    ROOT / "skills/e2e-mobile": frozenset({"e2e.mobile"}),
    ROOT / "skills/e2e-desktop": frozenset({"e2e.desktop"}),
}
