...
alternate browser E2E framework, after read-only detection, create the durable unsupported-framework outcome without adding Playwright infrastructure.
...
evidence. It can otherwise run directly: initialize
